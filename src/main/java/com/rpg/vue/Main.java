...
public class Main {
	...
	public static void main(String[] args) {
		PersonnageEntity felix = new JoueurEntity(2, "Lalaina", Sexe.M, Role.Ep, 150, 1280, 2280, 300, 300, 2000, 3, "img/epeisteM.png",
				1000);
		PersonnageEntity fermiere = new AllieEntity(2, "Basma", Sexe.F, Role.Ar, 150, 1280, 2280, 300, 300, 2000, 3, "img/paysanne.png");
